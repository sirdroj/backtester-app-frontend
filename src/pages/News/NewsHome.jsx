...
const NewsHome = () => {
    ...
    const tabdc={0:<WatchlistSentibytes />,1:<GlobalNews />,2:<WatchlistNews />,3:<PortfolioSentibytes />}
  ...
  return (
    <div>
        <nav className='flex justify-between px-2 '>
            ...
            <div className={`px-2 border-blue-600 cursor-pointer text-[14px] ${curTab==0?"border-b-2":""}`} onClick={()=>setTab(0)}>Watchlist SentiBytes</div>
