...
const AddPortfolioPopup = () => {
  ...
  return (
    <div
      className={`fixed ${
        showAddPortfolioPopup ? "flex" : "hidden"
      ...
      <div className=" bg-slate-700 p-10 rounded-md">
        <div className="flex justify-end">
          <button
            ...
            onClick={() => set_showAddPortfolioPopup(false)}
          >
            close
          </button>
        </div>
        <h1 className="text-center text-lg font-bold">Add Portfolio</h1>
        <form
